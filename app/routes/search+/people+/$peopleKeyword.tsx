...
export const meta = mergeMeta(({ data, params }) => {
  ...
  return [
    { title: `twinkl - Search results for ${params.peopleKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `https://twinkl.web.app/search/people/${params.peopleKeyword}`,
    },
    { property: 'og:title', content: `twinkl - Search results for ${params.peopleKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `twinkl - Search results for ${params.peopleKeyword}` },
  ];
});
