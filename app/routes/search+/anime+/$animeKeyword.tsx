...
export const meta = mergeMeta(({ data, params }) => {
  ...
  return [
    { title: `twinkl - Search results for ${params.animeKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `https://twinkl.web.app/search/anime/${params.animeKeyword}`,
    },
    { property: 'og:title', content: `twinkl - Search results for ${params.animeKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `twinkl - Search results for ${params.animeKeyword}` },
  ];
});
