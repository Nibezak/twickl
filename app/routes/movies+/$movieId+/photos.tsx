...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      ...
      {
        property: 'og:url',
        content: `https://watchpartychill.vercel.app/movies/${params.movieId}/photos`,
      },
...
const MoviePhotosPage = () => {
  ...
  return (
    // this is where photos related to the movie/ Tv series / Anime would go
    // but since I haven't decided how to go about it, I am going to just return to null
    <div className="flex w-full items-center justify-center">
      <h4 className="opacity-70">This Page is Coming on Later releases</h4>
    </div>
  );
};
