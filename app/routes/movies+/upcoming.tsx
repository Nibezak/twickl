...
export const meta = mergeMeta(() => [
  { title: 'twinkl - Upcoming Movies' },
  { name: 'description', content: 'Upcoming Movies' },
  { property: 'og:url', content: 'https://twinkl.web.app/movies/upcoming' },
  { property: 'og:title', content: 'twinkl - Upcoming Movies' },
  { property: 'og:description', content: 'Upcoming Movies' },
  { name: 'twitter:title', content: 'twinkl - Upcoming Movies' },
