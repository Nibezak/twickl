...
export const meta = mergeMeta(() => [
  { title: 'twinkl Anime - Genres' },
  { name: 'description', content: 'Anime Genres' },
  { property: 'og:url', content: 'https://twinkl.web.app/genres/anime' },
  { property: 'og:title', content: 'twinkl Anime - Genres' },
  { property: 'og:image', content: 'https://twinkl.web.app/api/ogimage?it=anime' },
  { property: 'og:description', content: 'Anime Genres' },
  { name: 'twitter:title', content: 'twinkl Anime - Genres' },
